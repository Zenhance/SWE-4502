...
public class Logger_ShouldStoreCommandHistoryLogs
{
    [Fact]
    public void loggerTest()
    {
        ...
        Assert.Equal(COMMANDTYPE.REDO, commandManager.commandLogs[commandManager.commandLogs.Count - 1].Commandtype);
    }
}