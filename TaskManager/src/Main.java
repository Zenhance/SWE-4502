...
public class Main {
    public static void main(String[] args) {
        ...
        Issue issue1 = new Issue("1", "Fix Bug", "Fix the login bug", Priority.HIGH, "Alice", Arrays.asList("bug", "login"));
        ...
        Issue updatedIssue = new Issue("1", "Fix Bug", "Fix the login bug and improve performance", Priority.CRITICAL, "Alice", Arrays.asList("bug", "login"));
        Command updateCommand = new Update_Issue(repository, "1", updatedIssue);
        updateCommand.execute();
        logger.log("Update", "Updated issue with ID 1");
        ...
        logger.log("Update", "Changed status of issue with ID 1 to IN_PROGRESS");
        statistics.incrementCommandCount("Update");
