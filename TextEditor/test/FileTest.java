...
public class FileTest {
    ...
    public void testSaveAndLoadSingleState() {
        ...
        EditorMemento newMemento = newHistory.getMementos().get(size);

        assertEquals("Test content", newMemento.getContent());
        assertEquals(5, newMemento.getCursorPosition());
        assertEquals("content", newMemento.getSelection());
